    ...
    <div class="container">
        ...
        <div class="row mt-8">
            <div class="col-md-12 mt-8">
              ...
              <h2>Listed Property Table</h2>
              <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search Property ID" style="margin-bottom: 10px;width: 200px;"></br>
                <table class="table" id="myTable">
                    ...
                    <tbody>
                        ...
                        @foreach ($output as $output)
                            <tr>
                                <td>{{$output->id}}</td>
                                <td>{{$output->propname}}</td>
                                <td>{{$output->title}}</td>
                                <td>RM {{$output->price}}</td>
                                <td>{{$output->furnish}}</td>
                                <td>{{$output->type}}</td>
                                <td>{{$output->owner}}</td>
                                <td>{{$output->created_at}}</td>
                                <td><a href={{"advw/".$output['id']}}>View Detail</a></td>
